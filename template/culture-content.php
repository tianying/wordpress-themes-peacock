			 	  ...
			 	  <div class="col-md-9">
				  	   ...
				  	   <div class="part">
					   		<div class="main-content text-color-gray">
								<?php echo do_shortcode('[custom_type_content type="culture" taxonomy="culture_category"]'); ?>
								<div class="notice-related-articles">
									<h2>相关链接</h2>	
									<ul>
										<?php echo do_shortcode('[custom_type_related_articles type="culture"]'); ?>
									</ul>
								</div>
							</div>
					   </div>
